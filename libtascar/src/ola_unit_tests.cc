...
TEST(partitioned_conv_t, filterlong)
{
  ...
  d[0] = 1.0;
  ola.process( d, d, false );
  ASSERT_NEAR( 0.0f, d[0], 1e-7f );
  ASSERT_NEAR( 0.5f, d[1], 1e-7f );
  ASSERT_NEAR( 0.5f, d[2], 1e-7f );
  ASSERT_NEAR( 0.0f, d[3], 1e-7f );
  d.clear();
  ola.process( d, d, false );
  ASSERT_NEAR( 0.0f, d[0], 1e-7f );
  ASSERT_NEAR( 0.0f, d[1], 1e-7f );
  ASSERT_NEAR( 0.0f, d[2], 1e-7f );
  ASSERT_NEAR( 0.0f, d[3], 1e-7f );
  d.clear();
  ola.process( d, d, false );
  ASSERT_NEAR( 0.0f, d[0], 1e-7f );
