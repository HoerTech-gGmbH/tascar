...
\begin{tscattributes}
  \indattr{fres}  & Resonance frequency in Hz (1200)         \\
  \indattr{q}     & $q$-factor of the resonance filter (0.8) \\
  \indattr{scale} & Distortion factor $s$ (0.5)              \\
  \indattr{gain}  & Post-gain $g$ in dB (0)                  \\
\end{tscattributes}
