...
. Example :
\tscexample[linerange={5-7},firstnumber=5]{example_diffuse}
...
To activate IIR speaker correction filter, provide both \attr{compA}
and \attr{compB} attributes. The filter coefficients follow the same
convention as in GNU Octave/Matlab. Please note that filter
coefficients are specific to the sampling rate, and not automatically
recalculated upon sampling rate changes.
