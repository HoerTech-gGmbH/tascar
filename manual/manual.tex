...
environments \citep{Grimm2015a,Grimm2016a,Grimm2019}. By means of \tascar{}, the sound
...
The file names given in the name attribute of the \elem{include}
...
\begin{tscelements}
\refelem{position}, \elem{boundingbox},\refelem{orientation}, \refelem{creator}, \refelem{sndfile}, \elem{plugins}
\end{tscelements}
...
Furse-Malham normalization and channel order (wxyz). This output is
