...
\begin{tscattributes}
\attr{qtmurl}     & Qualisys Track Manager URL of USC interface (default: {\tiny osc.udp://localhost:22225/}) \\
\attr{timeout}    & Timeout in seconds (default: 1)                                                           \\
\attr{dataurl}    & OSC URL where data is sent to (or empty for no OSC sending, default)                      \\
\attr{dataprefix} & OSC path prefix, will be followed by slash + rigid names (default: ``'')                  \\
\end{tscattributes}
