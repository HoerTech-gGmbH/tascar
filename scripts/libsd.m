...
% lsd = libsd();
% sPar = struct();
% sPar.fields = {'method','length','rating'};
% sPar.values = {{'methodA','methodB'},[0,1,3]};
% sData = lsd.eval( sPar, @test_libsdeval, 'nrep', 5);
% lsd.plotwizzard( sData );

% This file was generated by "bake_mlib sd".
% Do not edit! Edit sources sd_*.m instead.
%
% Date: 03-Dec-2024 16:49:50
sLib = struct;
...
sLib.plotwizard = @sd_plotwizard;
sLib.help.plotwizard = @help_plotwizard;
...
function help_csv
disp([' CSV - sd_ - export data structure as  file',char(10),'',char(10),' Usage:',char(10),'  sd = libsd();',char(10),'  sd.csv( data, fname );',char(10),'',char(10),' ',char(10),'  Usage:',char(10),'  sd_csv( data, fname )',char(10),'']);
...
disp([' STRUCT2PARSTRUCT - - convert field names of structure into param',char(10),'',char(10),' Usage:',char(10),'  sd = libsd();',char(10),'  s = sd.struct2parstruct( sIn );',char(10),'',char(10),'  control structure',char(10),' ',char(10),'  Usage:',char(10),'  s = sd_struct2parstruct( sIn )',char(10),'  ',char(10),'  Fieldnames of sIn are converted into content of ''s.fields'',',char(10),'  contents of sIn are converted into content of ''s.values''.',char(10),' ',char(10),'  Example:',char(10),'  sIn.par1 = {''apple'',''orange'',''lemmon''}',char(10),'  sIn.par2 = [1:3]',char(10),'  s = sd.struct2parstruct( sIn )',char(10),'']);
