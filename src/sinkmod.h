...
namespace TASCAR {
  ...
  public:
    ...
    virtual void add_pointsource(const pos_t& prel, const wave_t& chunk, const std::vector<wave_t>& output, sinkmod_base_t::data_t*) = 0;
    virtual void add_diffusesource(const pos_t& prel, const amb1wave_t& chunk, const std::vector<wave_t>& output, sinkmod_base_t::data_t*) = 0;
    virtual uint32_t get_num_channels() = 0;
    virtual std::string get_channel_postfix(uint32_t channel) const { return "";};
    virtual sinkmod_base_t::data_t* create_data() { return NULL;};
  protected:
  };
  ...
  typedef void (*sinkmod_add_pointsource_t)(TASCAR::sinkmod_base_t* h,const pos_t& prel, const wave_t& chunk, const std::vector<wave_t>& output, sinkmod_base_t::data_t*,sinkmod_error_t errfun);
  typedef void (*sinkmod_add_diffusesource_t)(TASCAR::sinkmod_base_t* h,const pos_t& prel, const amb1wave_t& chunk, const std::vector<wave_t>& output, sinkmod_base_t::data_t*,sinkmod_error_t errfun);
  ...
  typedef sinkmod_base_t::data_t* (*sinkmod_create_data_t)(TASCAR::sinkmod_base_t* h,sinkmod_error_t errfun);
  ...
  public:
    ...
    void write_xml();
    virtual ~sinkmod_t();
    virtual void add_pointsource(const pos_t& prel, const wave_t& chunk, const std::vector<wave_t>& output, sinkmod_base_t::data_t*);
    virtual void add_diffusesource(const pos_t& prel, const amb1wave_t& chunk, const std::vector<wave_t>& output, sinkmod_base_t::data_t*);
    virtual uint32_t get_num_channels();
    virtual std::string get_channel_postfix(uint32_t channel);
    virtual sinkmod_base_t::data_t* create_data();
  private:
    std::string sinktype;
    void* lib;
...
#define REGISTER_SINKMOD(x)                     \
  extern "C" {                                  \
    ...
    void sinkmod_add_pointsource(TASCAR::sinkmod_base_t* h,const pos_t& prel, const wave_t& chunk, const std::vector<wave_t>& output, sinkmod_base_t::data_t* data) \
    {                                           \
      x*   ptr(dynamic_cast<x*>(h));            \
      if( ptr ){                                \
    ...
    void sinkmod_add_diffusesource(TASCAR::sinkmod_base_t* h,const pos_t& prel, const amb1wave_t& chunk, const std::vector<wave_t>& output, sinkmod_base_t::data_t* data) \
    {                                           \
      x*   ptr(dynamic_cast<x*>(h));            \
      if( ptr ){                                \
    ...
    uint32_t sinkmod_get_num_channels(TASCAR::sinkmod_base_t* h) \
    {                                           \
      x*   ptr(dynamic_cast<x*>(h));            \
      if( ptr ){                                \
    ...
    std::string sinkmod_get_channel_postfix(TASCAR::sinkmod_base_t* h,uint32_t channel) \
    {                                           \
      x*   ptr(dynamic_cast<x*>(h));            \
      if( ptr ){                                \
    ...
    sinkmod_base_t::data_t* sinkmod_create_data(TASCAR::sinkmod_base_t* h) \
    {                                           \
      x*   ptr(dynamic_cast<x*>(h));            \
      if( ptr ){                                \
        try { return ptr->create_data(); }      \
        catch(const std::exception&e ){         \
          errfun(e.what());                     \
        }                                       \
      }else                                     \
