...
class amb3h3v_t : public TASCAR::sinkmod_base_t {
public:
...
void amb3h3v_t::add_pointsource(const TASCAR::pos_t& prel, const TASCAR::wave_t& chunk, std::vector<TASCAR::wave_t>& output, sinkmod_base_t::data_t* sd)
{
...
void amb3h3v_t::add_diffusesource(const TASCAR::pos_t& prel, const TASCAR::amb1wave_t& chunk, std::vector<TASCAR::wave_t>& output, sinkmod_base_t::data_t* sd)
{
  data_t* d((data_t*)sd);
  float az = prel.azim();
...
TASCAR::sinkmod_base_t::data_t* amb3h3v_t::create_data(double srate,uint32_t fragsize)
{
