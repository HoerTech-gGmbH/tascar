...
namespace TASCAR {
  ...
  protected:
    std::vector<TASCAR::async_file_read_t*> sndfile;
...
{
  TASCAR::async_file_read_t* sfile(new TASCAR::async_file_read_t(1));
...
namespace TASCAR {
  ...
  */
  ...
  public:
    TASCAR::async_file_read_t bg_sound;
  };
...
{
  try{
    ///TASCAR::async_file_read_t f( 512 );
    ///float buf[1000];
    ///sleep(1);
